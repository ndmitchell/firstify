...
Note that a program may have general application, yet still be first-order according to this definition. General application makes use of a functional value, so will usually be accompanied by the creation of a functional value elsewhere within the program.
