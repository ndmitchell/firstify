...
Their use is ubiquitous -- even a simple numeric literal in Haskell typically expands into the application of a function taking a tuple containing many functional values. This operation occurs as part of the dictionary transformation for the implementation of type classes \cite{wadler:type_classes}.
