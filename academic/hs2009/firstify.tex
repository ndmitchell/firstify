...
\todo{not clear how free variables are handled (in Example 9 instead of |\x->x| what if you had |\x-> x:xs| ?). It is not
...
\todo{make clear we do dead-code on both to compare}
