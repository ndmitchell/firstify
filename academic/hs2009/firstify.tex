...
\todo{The second paragraph in 4.1.2 mentions "expensive 1", but to actually get to that expression you have to beta-reduce (f 1), which took me some time to figure out (I was pondering whether you meant expensive x first).}
