...
\begin{definition}
An expression |e| is a \textit{boxed lambda} iff |isBox e == True|, where |isBox| is defined as in Figure \ref{fig:boxed_lambda}. A boxed lambda is an expression which evaluates to a functional value inside a constructor.
\end{definition}
