...
\todo{copy updates from detlef in thesis}
...
\todo{rewrite subsection with new meanings}
...
\todo{move to the new definition of first-order}
...
\todo{move stuff from uses of functional values}
