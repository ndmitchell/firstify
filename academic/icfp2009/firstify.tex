...
\todo{we have algebraic types with arbitrary numbers of constructors, each with a fixed arity}

\todo{the language is pure and lazy}
...
\todo{We assume that type restrictions ensure we do not apply to a constrctor, and only case on a constructor}
...
\todo{after a trivial dead-code analysis to remove entirely unused function definitions}
