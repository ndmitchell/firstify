...
\todo{Mainly, there needs to be a clear answer to the questions such as
the following:
Why should the world be interested in this incomplete firstification method when there is Reynolds' complete method already available?
What is good or about it, or interesting, or both?
What is it useful for?}

\todo{say in the introduction that the method is partial}

\todo{say why having a partial method is still useful - and how being mainly first-order is still useful}

\todo{say that just for analysis means slowdown is unimportant}

\todo{be careful: function vs top-level defined function}

\todo{emphasise that Reynold's + mine first will give a much simpler program}
